		...
		<br />
		 <?php
			...
			if(isset($_POST['submit'])){
				...
				$sql = mysqli_query($cnx, "SELECT id FROM users WHERE pseudo = '$pseudo'") or die('Erreur de la requête SQL');
				...
				if($erreur == null){
					...
					$sql = mysqli_query($cnx, "INSERT INTO users(pseudo, nom, prenom, sexe, password) VALUES('$pseudo', '$nom', '$prenom', '$sexe', '$password')") or die('Erreur de la requête SQL');
					if($sql){
				...
				<div class = "col-lg-offset-4 col-lg-4 col-lg-offset-4">
					<form action = "inscription.php" method = "post" class = "well">
						...
						<div class = "form-group">
							...
							<input type = "radio" name = "sexe" value = "Masculin" checked class = "radio-inline"> Masculin <input type = "radio" name = "sexe" value = "Feminin"  class = "radio-inline"> Féminin <input type = "radio" name = "sexe" value = "Autre" class = "radio-inline"> Autre
						</div>
						<div class = "form-group">
